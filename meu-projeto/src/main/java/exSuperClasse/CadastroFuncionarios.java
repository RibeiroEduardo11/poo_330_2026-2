...
public class CadastroFuncionarios{
    ...
    private void carregaFuncionarios(){
        ...
        funcionarios.add(new Funcionario("C26101","Lala Pata",4220.0, true));
        funcionarios.add(new Funcionario("C26102","Lele Pata",1283.0, true));
        funcionarios.add(new Funcionario("C26103","Lili Pata",12438.0, true));
    }
